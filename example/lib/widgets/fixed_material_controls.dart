...
class FixedMaterialControls extends StatefulWidget {
  const FixedMaterialControls({this.showPlayButton = true, super.key});

  final bool showPlayButton;

  @override
  State<StatefulWidget> createState() {
    return _FixedMaterialControlsState();
  }
}

class _FixedMaterialControlsState extends State<FixedMaterialControls>
