...
class NativeCacheVideoPlayerPlatform extends VideoPlayerPlatform implements NativeCachePlatformExtension {
  final MethodChannel _channel = const MethodChannel('native_cache_video_player');

  /// Registers this class as the default instance of [VideoPlayerPlatform].
  static void registerWith() {
    VideoPlayerPlatform.instance = NativeCacheVideoPlayerPlatform();
  }
...
class NativeCacheVideoPlayerPlatformWithEvents extends NativeCacheVideoPlayerPlatform {
    /// Registers this class as the default instance of [VideoPlayerPlatform].
    static void registerWith() {
        VideoPlayerPlatform.instance = NativeCacheVideoPlayerPlatformWithEvents();
    }
